...
/** @type {string} */
const CACHE_VERSION = '1766658843|16607788112';
/** @type {string} */
const CACHE_PREFIX = 'narrative-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'narrative.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["narrative.html","narrative.js","narrative.offline.html","narrative.icon.png","narrative.apple-touch-icon.png","narrative.audio.worklet.js","narrative.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["narrative.wasm","narrative.pck"];
